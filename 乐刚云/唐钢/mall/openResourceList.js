$(function(){
    ...
    var mytxt='    	<div class="subTableList">'+
			...
			'            <div class="l pct10 tc smallsetHover"><a href="javascript:void(0)" class="green">议价购买</a>'+
			'<span class="hover_ck tl" style="width:240px">'+
            '            <i class="dib abs hover_ckdot" style="right:20px;"></i>'+
            '            <span class="f12 dib">交易时间工作日<span class="red">10:30-17:00</span>，其余时间库存<br/>更新维护、价格仅供参考。如有任何疑问,所<br/>有货主随时欢迎和期待您的来电！</span>'+
             '         </span>'+
